...
if __name__ == '__main__':
    dataset_files = ['/root/docker_mounts_sata/pap_work_vnni/dataset/line01/cut_1/coco/annotations/pos_valid.json',
                     '/root/docker_mounts_sata/pap_work_vnni/dataset/line01/cut_1/coco/annotations/neg_size80to85_0.3times_valid.json']
    merge_coco = MergeCOCO(dataset_files)
    merge_coco.merge()
    merge_coco.save(save='/root/docker_mounts_sata/pap_work_vnni/dataset/line01/cut_1/coco/annotations/pos_valid_merge.json')
