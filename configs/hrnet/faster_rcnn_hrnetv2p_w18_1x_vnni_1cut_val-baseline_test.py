...
data_root = '/root/docker_mounts_sata/pap_work_vnni/dataset/line01/cut_1/coco/'       ###
img_norm_cfg = dict(
...
data = dict(
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/merged_valid.json',
        img_prefix=data_root + 'images/',
...
log_level = 'INFO'
work_dir = './work_dirs/faster_rcnn_hrnetv2p_w18_1x_vnni_1cut_val-baseline_test'
load_from = None
resume_from = None
workflow = [('train', 1)]
